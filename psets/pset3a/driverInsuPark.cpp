...
int main() {
	...
	do {
		...
		case 3:
			...
			while (1) {
				int n = GetInt("\tEnter a number to compute N fibonacci(0 to quit): ");
				if (n == 0) break;
		...
		case 4:
			...
			while (1) {
				int n = GetInt("\tEnter a number of Bunnies(0 to quit): ");
				if (n == 0) break;
		...
		case 5:
			...
			while (1) {
				int n = GetInt("\tEnter a number of Funnies(0 to quit): ");
				if (n == 0) break;
		...
		case 6:
			...
			while (1) {
				int n = GetInt("\tEnter a row number for Triangle(0 to quit): ");
				if (n == 0) break;
		...
		case 7:
			...
			while (1) {
				int n = GetInt("\tEnter a number to sum digits(0 to quit): ");
				if (n <= 0) break;
		...
		case 8:
			...
			while (1) {
				int n = GetInt("\tEnter a number to count 8(0 to quit): ");
				if (n <= 0) break;
		...
		case 9:
			...
			while (1) {
				int base = GetInt("\tEnter a base number(0 to quit): ");
				if (base <= 0) break;
				int n = GetInt("\tEnter a power number(0 to quit): ");
				if (n <= 0) break;
				cout << "\tpowerN(" << base << "," << n << ") = " << powerN(base, n) << endl;
			}
